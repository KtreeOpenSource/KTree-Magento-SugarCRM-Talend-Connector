...
public class MagentoServiceLocator extends org.apache.axis.client.Service implements routines.MagentoService {
    ...
    private java.lang.String Mage_Api_Model_Server_HandlerPort_address = "http://ktc11.ktree.org/magento13/index.php/api/index/index/";
    ...
    public routines.Mage_Api_Model_Server_HandlerPortType getMage_Api_Model_Server_HandlerPort() throws javax.xml.rpc.ServiceException {
    ...
    public routines.Mage_Api_Model_Server_HandlerPortType getMage_Api_Model_Server_HandlerPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            routines.Mage_Api_Model_Server_HandlerBindingStub _stub = new routines.Mage_Api_Model_Server_HandlerBindingStub(portAddress, this);
    ...
    public void setMage_Api_Model_Server_HandlerPortEndpointAddress(java.lang.String address) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (routines.Mage_Api_Model_Server_HandlerPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                routines.Mage_Api_Model_Server_HandlerBindingStub _stub = new routines.Mage_Api_Model_Server_HandlerBindingStub(new java.net.URL(Mage_Api_Model_Server_HandlerPort_address), this);
                _stub.setPortName(getMage_Api_Model_Server_HandlerPortWSDDServiceName());
                return _stub;
            }
        }
